...
public class EventControllerTest {
    ...
    public void createEvent() throws Exception {
        mockMvc.perform(post("/api/events")
                ...
                .param("lessorname", "황태원")
                .param("roomno", "402")
                .param("startdatetime", "2019-03-09T11:00")
                .param("enddatetime", "2019-03-09T13:00"))
                .andExpect(status().isCreated())
                ...
                .andExpect(jsonPath("startDateTime").value("2019-03-09T11:00:00"))
                .andExpect(jsonPath("endDateTime").value("2019-03-09T13:00:00"))
                .andDo(print());
    }
